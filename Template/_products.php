...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./images/products/Nike Air VaporMax Plus.png" ?>" alt="Nike Vapormax" class="img-fluid">
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="top_sale_submit" class="btn btn-warning font-size-16 ">Add to Cart</button>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14"> 20,534 users ratings: 4.2 / 5</a>
                </div>
                <hr class="m-0">
                ...
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>Was:</td>
                        <td><strike>R1,799</strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Price:</td>
                        <td class="font-size-20 text-danger">R<span><?php echo $item['item_price'] ?? 0; ?></span><small class="text-dark font-size-12">&nbsp;&nbsp;tax included</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">R100</span></td>
                    </tr>
                </table>
                <!---    !product price       -->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">Sportscene </a>(4.5 out of 5 | 18,198 ratings)</small>
